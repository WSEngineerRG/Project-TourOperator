    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex justify-center p-4">
            ...
            <div class="flex flex-row flex-wrap place-content-center items-stretch p-8 m-auto">
                <?php foreach ($getDestinations as $show){?>
                    <div class="shadow-md m-5 max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg"
                                 src="<?= $show->getImage() ?>" alt=".<?= $show->getName() ?>.">
                        </a>
                        <div class="p-5">
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><?= $show->getName() ?></h5>
                            </a>
                            <h3></h3>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise
                                technology acquisitions of 2021 so far, in reverse chronological order.</p>
                            <form action="./src/Pages/Destinations.php?City_name=<?= $show->getName() ?>">
                                <input type="hidden" name="City_name" value="<?= $show->getName() ?>">
